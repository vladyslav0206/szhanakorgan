            ...
            <div class="col-md-12">
                <div class="col-md-8" style="padding-left: 0px">
                    <div class="box box-primary">
                        ...
                        @endif
                        @if($row->id > 0)
                            <form action="/admin/menu/{{$row->id}}" method="POST"  enctype="multipart/form-data">
                                            ...
                                            <div class="nav-tabs-custom">
                                                <div class="tab-content">
                                                    <div class="active tab-pane" id="rus">
                                                        ...
                                                        <div class="form-group">
                                                            <label>URL</label>
                                                            <input id="url" value="{{ $row->url }}" type="text" class="form-control" name="url" placeholder="Введите">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Позиция</label>
                                                            <input id="position" value="{{ $row->position }}" type="number" max="20" class="form-control" name="position" placeholder="Введите">
                                                        </div>
                                                        <div class="form-group">
