...
_extend(KCmd, {
	...
	underline : function() {
		return this.toggle('<span class="other-news-div" style="text-decoration: underline">еще новости</br></span>', {
			span : '.text-decoration=underline',
			u : '*'
		});
	},
	strikethrough : function() {
		return this.toggle('<span class="turik-second" style="text-decoration: underline"></span>', {
